...
$barang_query = "SELECT bk.barang_keluar_id, bk.plg, bk.barang_id, bk.kode_bk, bk.user_id, b.nama_barang, b.satuan, bk.jumlah, bk.harga_jual, bk.tanggal_keluar, bk.dibuat, byr.bayar, byr.kembalian
...
if (!empty($search_start_date) && !empty($search_end_date)) {
    $where_clause .= " WHERE bk.tanggal_keluar BETWEEN ? AND ?";
    $search_done = true; 
}
$barang_query .= $where_clause . " GROUP BY bk.kode_bk ORDER BY bk.barang_keluar_id DESC";
            ...
            <li class="nav-item">
                ...
                <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionSidebar">
                    <div class="bg-primary py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item text-white" href="Laporan_stok.php">Laporan Data Stok</a>
                        <a class="collapse-item text-white" href="Laporan_barang_masuk.php">Laporan Barang Masuk</a>
                        <a class="collapse-item text-white font-weight-bold" href="laporan_barang_keluar.php">Laporan Barang Keluar</a>
                    </div>
                </div>
            </li>
            <hr class="sidebar-divider">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <?php if ($search_done) : ?>
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <a href="../script/cetak_laporan_bk.php?start_date=<?php echo $search_start_date; ?>&end_date=<?php echo $search_end_date; ?>" class="btn btn-primary"><i class="fas fa-download"></i> Download PDF</a>
                        </div>
                    <?php endif; ?>
                    <div class="container-fluid">
                                            ...
                                            <?php if ($search_done) : ?>    
                                                <?php foreach ($barangs as $index => $barang) : ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo htmlspecialchars($barang['kode_bk'], ENT_QUOTES, 'UTF-8'); ?></td>
                                                        <td><?php echo htmlspecialchars($barang['plg'], ENT_QUOTES, 'UTF-8'); ?></td>
                                                        <td><?php echo date('d-M-Y', strtotime($barang['tanggal_keluar'])); ?></td>
                                                    </tr>
                                                <?php endforeach; ?>
                                            <?php endif; ?>
                                        </tbody>
