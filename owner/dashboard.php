        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <?php if(isset($_SESSION['logged_in']) && $_SESSION['logged_in']) {echo "<div class='success'>Login Berhasil Sebagai Pemilik!</div>";unset($_SESSION['logged_in']);}?>
    ...
    <script>
        $(document).ready(function(){
            ...
            if (localStorage.getItem("loggedIn")) {
                alert("Login Berhasil Sebagai Pemilik !");
